...
for entry in entries:    
    ...
    if my_os == "Windows":
        defaultTarget = "..\\samples\\"+str(entry[:-4])
    ...
    parser.add_argument("-tn", type=str, default="brownnoise")
...
for item, value in accuracy.items():
    if str(item) in value:
        existe += 1
    total += 1
print("Accuracy: "+str((existe/total)*100))
print("Tempo de execução:", timeFinal)
